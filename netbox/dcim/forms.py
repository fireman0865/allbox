...
from dcim.models.device_components import Config
class ConfigFilterForm(BootstrapMixin, forms.Form):
    ...
    config_date = forms.DateField(widget=forms.widgets.DateInput(attrs={'type': 'date'})
    ,required=False)
    config_type = forms.MultipleChoiceField(
    ...
    class Meta:
        model=Config
        fields=['device','session','config_date','config_type']


class NameForm(BootstrapMixin,forms.Form):
    date = forms.DateField(widget=forms.widgets.DateInput(attrs={'type': 'date'}))
    date1 = forms.DateField(widget=forms.widgets.DateInput(attrs={'type': 'date'}))
    ...
    class Meta:
        ...
        fields = Configuration_File.csv_headers
        exclude=['files','device','date','year','name']
    """
class NameForm1(BootstrapMixin,forms.Form):
    date1 = forms.DateField(widget=forms.widgets.DateInput(attrs={'type': 'date'}))
    date2 = forms.DateField(widget=forms.widgets.DateInput(attrs={'type': 'date'}))

'''
class ConfigConnectForm(BootstrapMixin,forms.Form):
    ...
    class Meta:
        model = ConfigConnect
        fields = ['host','username','password','ip','date']

class UploadFileForm(BootstrapMixin,forms.Form):
