...
class DeviceConfigTable(tables.Table):
    pk = ToggleColumn()
    files=tables.LinkColumn(viewname='dcim:config',
        args=[Accessor('pk')],verbose_name='Configuration')
    ...
    class Meta(DeviceComponentTable.Meta):
        model = Config
        fields=('pk','files','config_date','year')

class ConfigTable(BaseTable):
    pk = ToggleColumn()
    files=tables.LinkColumn(viewname='dcim:config',
        args=[Accessor('pk')],verbose_name='Files')


    class Meta(DeviceComponentTable.Meta):
        model = Config
        fields=('pk','files','config_date','session','config_type','actions')
        #show_header=False
        #orderable=False
