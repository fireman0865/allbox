...
urlpatterns = [
    ...
    path('devices/<int:pk>/configs/', views.DeviceConfigsView.as_view(), name='device_configs'),
    path('configs/<int:pk>/', views.ConfigView, name='config'),
    path('devices/<int:pk>/configs_diff', views.ConfigDiffView.as_view(), name='diffs'),
]
